        ...
        <form method="GET" action="{{ route('admin.layanan.index') }}" class="flex-1 max-w-md">
            <div class="relative">
                ...
                <input type="text" name="search" value="{{ $search }}" placeholder="Cari jenis atau kode layanan..."
                       class="w-full pl-10 pr-4 py-2.5 text-sm bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500/40 focus:border-sky-500 transition-colors" id="search-layanan">
            </div>
        </form>
