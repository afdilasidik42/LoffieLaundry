...
<body class="bg-gray-100 preload">
    ...
    <div class="flex min-h-screen w-full">
        {{-- Sidebar --}}
        <aside id="adminSidebar" class="sidebar-wrap bg-gray-900 text-white flex flex-col flex-shrink-0 fixed top-0 left-0 h-screen w-[256px] z-40 print:hidden">
            {{-- Brand --}}
            <div class="brand-container px-4 py-5 border-b border-gray-700/50 flex items-center gap-3 flex-shrink-0">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-3" style="min-width: 0;">
