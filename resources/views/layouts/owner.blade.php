    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-gray-900 text-white flex flex-col flex-shrink-0">
            ...
            <nav class="flex-1 px-4 py-6 space-y-1 overflow-y-auto">
                ...
                <p class="px-3 pt-5 text-[10px] font-semibold uppercase tracking-wider text-gray-500 mb-3">Manajemen</p>
                ...
                <a href="#"
                   class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-lg transition-colors duration-200
                    ...
                    Kelola Laporan
                    <span class="ml-auto text-[10px] bg-gray-700 text-gray-400 px-2 py-0.5 rounded-full">Sprint 3</span>
                </a>
            ...
            <div class="px-4 py-4 border-t border-gray-700/50">
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 bg-gray-700 rounded-full flex items-center justify-center text-sm font-semibold text-emerald-400">
