...
@section('page-description', 'Tambah data mesin laundry baru ke dalam sistem')
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gradient-to-r from-sky-50 to-cyan-50 border-b border-gray-200">
                <h3 class="text-sm font-semibold text-gray-700">Formulir Data Mesin</h3>
                <p class="text-xs text-gray-500 mt-0.5">Isi semua field yang bertanda <span class="text-red-500">*</span></p>
            </div>

            <form method="POST" action="{{ route('admin.mesin.store') }}" class="p-6 space-y-5" id="form-create-mesin">
                @csrf
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
                    <button type="submit" id="btn-simpan-mesin"
