        ...
        <form method="GET" action="{{ route('admin.mesin.index') }}" class="flex-1 max-w-md">
            <div class="relative">
                ...
                <input type="text" name="search" value="{{ $search }}" placeholder="Cari nama mesin..."
                       class="w-full pl-10 pr-4 py-2.5 text-sm bg-white border border-gray-300 rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-sky-500 transition-colors" id="search-mesin">
            </div>
        </form>
