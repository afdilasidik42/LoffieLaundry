...
@section('page-description', 'Perbarui data pelanggan ' . $pelanggan->nama)
    ...
    <div class="max-w-2xl">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="px-6 py-4 bg-gradient-to-r from-amber-50 to-orange-50 border-b border-gray-200">
                <h3 class="text-sm font-semibold text-gray-700">Edit Data Pelanggan</h3>
                <p class="text-xs text-gray-500 mt-0.5">Perbarui informasi pelanggan yang sudah ada</p>
            </div>

            <form method="POST" action="{{ route('admin.pelanggan.update', $pelanggan) }}" class="p-6 space-y-5" id="form-edit-pelanggan">
                @csrf
                @method('PUT')
                ...
                <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
                    <button type="submit" id="btn-update-pelanggan"
